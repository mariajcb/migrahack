...
df.loc[:, "Detainments"] = df.Arrests.str.replace(",", "").astype(int)
df.to_csv("data/CO_county_arrests.csv", index=False)
...
all_counties.to_csv("data/month_year_co_counties_arrest.csv", index=False)
